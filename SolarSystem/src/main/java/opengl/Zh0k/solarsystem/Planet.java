        ...
        colorIncrement=1.0f/(float)stacks;
        {
            ...
            for(phiIdx=0; phiIdx < m_Stacks; phiIdx++)
            {
                ...
                for(thetaIdx=0; thetaIdx < m_Slices; thetaIdx++)
                {
                    ...
                    vertexData[vIndex+0] = m_Scale*cosPhi0*cosTheta; //x1
                    vertexData[vIndex+1] = m_Scale*(sinPhi0*m_Squash); //y1
                    vertexData[vIndex+2] = m_Scale*(cosPhi0*sinTheta); //z1

                    vertexData[vIndex+3] = m_Scale*cosPhi1*cosTheta; //x2
                    vertexData[vIndex+4] = m_Scale*(sinPhi1*m_Squash); //y2
                    vertexData[vIndex+5] = m_Scale*(cosPhi1*sinTheta); //z2
                    ...
                    colorData[cIndex+3] = (float)1.0; //green elements
